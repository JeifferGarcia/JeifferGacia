    ...
    return <Fragment>
      ...
      <section className="About__title">
        ...
        <section className="About__images">
          ...
          <div className="About__images--description">
            <p>Henry Jeiffer Garcia Gutierrez</p>
            <p>Colombia</p>
            <p>23 Años</p>
          </div>
        </section>
        ...
        <section className="About__description">
          <p>Hola, soy Jeiffer Garcia un apasionado por la tecnología frontend, 
        ...
        <div className="About__btn">
          <Link className="btn" to="#">Descargar CV</Link>
        </div>
        </section>
